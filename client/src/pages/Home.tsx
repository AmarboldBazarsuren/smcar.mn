          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/25 text-white text-[15px] font-medium px-6 py-3.5 rounded-full transition"
              >
