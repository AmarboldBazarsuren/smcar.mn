...
const FUEL = {
  ...
  'LPG': { en: 'LPG', mn: 'Хий' },
  '하이브리드': { en: 'Hybrid', mn: 'Hybrid' },
  '전기': { en: 'Electric', mn: 'Цахилгаан' },
  '수소': { en: 'Hydrogen', mn: 'Устөрөгч' },
  '가솔린(LPG겸용)': { en: 'Gasoline/LPG', mn: 'Бензин/Хий' },
...
const BODY = {
  ...
  '준중형차': { en: 'Compact Sedan', mn: 'Дунд жижиг' },
  '중형차': { en: 'Midsize Sedan', mn: 'Дунд' },
  '준대형차': { en: 'Large Sedan', mn: 'Дунд том' },
  '대형차': { en: 'Full-size Sedan', mn: 'Том' },
  '경차': { en: 'Mini', mn: 'Маш жижиг' },
  'SUV': { en: 'SUV', mn: 'SUV' },
